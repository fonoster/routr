...
describe('@routr/connect/utils', () => {
  ...
  it('creates a new p-asserted-identity header', async () => {
    ...
    expect(headerModifier).to.have.property("value", "<sip:17066041487@sip.provider.net>")
  })
  ...
  it('creates a new remote-party-id header', async () => {
    ...
    expect(headerModifier).to.have.property("value", "<sip:17066041487@sip.provider.net>;screen=yes;party=calling")
  })
