...
import GetCommand from "../src/commands/agents/get"

const expect = chai.expect
const sandbox = sinon.createSandbox()

describe("@routr/ctl/agents/get", () => {
  let config: Config
  ...
  it("lists Agents in a table", async () => {
    sandbox.stub(SDK.Agents.prototype, "listAgents").resolves({
      items: [
        {
          ref: "d31f5fb8-e367-42f7-9884-1a7999f53fe8",
          name: "John Doe",
          username: "jdoe",
          domain: { domainUri: "sip.local" },
          maxContacts: 1,
          privacy: "PRIVATE",
          enabled: true
        }
    ...
    expect(stdout).to.contain("Domain")
