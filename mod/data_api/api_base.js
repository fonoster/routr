...
class APIBase {
    ...
    createFromJSON(jsonObj, alreadyExist, hasUnfulfilledDependency,
        getCacheKey) {
    ...
    getResources(filter, page, itemsPerPage) {
        return this.ds
          .withCollection(this.resourceType).find(filter, page, itemsPerPage)
    }

    getResource(ref) {
        return this.ds
          .withCollection(this.resourceType).get(ref)
    }
