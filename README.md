...
developers and VoIP implementors. At the moment you can add your sip devices and group them using domains and connect with the PSTN (public switched telephone network) using a Sip Gateway. To learn some key concepts and get up and running please see the [wiki](https://github.com/psanders/sip.io/wiki/Home). You want get involve in the development of this project, please contact me at twitter or gitter.
